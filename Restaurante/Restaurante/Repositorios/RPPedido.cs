...
namespace Restaurante.Repositorios
{
    public class RPPedido
    {
        ...
        {
            new Pedido() { Id = 1, Descripcion = "Pedido 1" , IdRestaurante = 1, IdRepartidor=1 , IdCliente= 1},
            new Pedido() { Id = 2, Descripcion = "Pedido 2" , IdRestaurante = 1, IdRepartidor=2 , IdCliente= 2},
            new Pedido() { Id = 3, Descripcion = "Pedido 3" , IdRestaurante = 1, IdRepartidor=3 , IdCliente=3}
        };
